...
with open("Advent of Code\\AoC2022\Day 5\input.txt", "r") as file:
    for line in file:
        if "[" in line:
            for x in line:
                counter += 1
            ...
            line.strip() == ""
        ):  # after having some issues, I found out that the original order of the crates is reversed in my code
            tmp = 8
            while tmp >= 0:
                cargo[tmp].reverse()
                tmp -= 1
